...
namespace SportFutbolWeb.Controllers
{
    public class TarifasController : Controller
    {
        ...
        public TarifasController(SportFutbolContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Tarifas != null ? 
                          ...
                          Problem("Entity set 'SportFutbolContext.Tarifas'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Precio")] Tarifa tarifa)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Precio")] Tarifa tarifa)
        {
            if (id != tarifa.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'SportFutbolContext.Tarifas'  is null.");
            }
            var tarifa = await _context.Tarifas.FindAsync(id);
            if (tarifa != null)
            {
